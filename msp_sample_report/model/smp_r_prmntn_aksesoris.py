...
class SampleReportPermintaanAksesoris(models.AbstractModel):
    """
    Class untuk Custom Data Report sebelum di render ke dalam template
    """
    _name = 'report.msp_sample_report.smp_r_prmntn_aksesoris'
    ...
    def get_report_values(self, docids, data=None):
        ...
        for order in msd2:
            for record in order.mrp_bom_line_ids:
                if record.product_id.product_tmpl_id.categ_id.id==5 or record.product_id.product_tmpl_id.categ_id.id==70 :
